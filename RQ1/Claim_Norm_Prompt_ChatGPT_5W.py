...
for f in files:
    ...
    with open('Claim_Norm_chatgpt/'+org_name+"_5W.json","w") as f:
        json.dump(claim_norm,f,indent=True)
    df['claim_norm'] = claim_norm
    df.to_excel('Claim_Norm_chatgpt/'+org_name+"_5W.xlsx", index=False)
