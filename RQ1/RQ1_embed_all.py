...
for media in media_name:
    data1 = pd.read_excel("Claim_Norm_chatgpt/" + media + ".xlsx")
    l = len(data1)
    print("\n\n","---"*10,media, l)
    data2 = pd.read_excel("Claim_Norm_chatgpt/" + media + "_5W.xlsx")
    ...
    data1.to_excel("Claim_Norm_chatgpt/" + media + "_emb_all.xlsx",index=False)